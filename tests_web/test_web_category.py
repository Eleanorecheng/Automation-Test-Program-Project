...
@pytest.mark.parametrize("category, expected_products_list", [('女裝',['前開衩扭結洋裝','透肌澎澎防曬襯衫','小扇紋細織上衣','活力花紋長筒牛仔褲','精緻扭結洋裝','透肌澎澎薄紗襯衫']),
                                                              ('男裝', ['純色輕薄百搭襯衫','時尚輕鬆休閒西裝','經典商務西裝']),
                                                              ('配件',['夏日海灘戶外遮陽帽', '經典牛仔帽', '卡哇伊多功能隨身包','柔軟氣質羊毛圍巾'])])
def test_category(driver, category, expected_products_list, logger, allure_screenshot):
